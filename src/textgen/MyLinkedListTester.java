...
public class MyLinkedListTester {
    ...
    public void testRemove() {
        ...
        try {
            list1.remove(-1);
            fail("Remove: check out of bounds to low");
        } catch (IndexOutOfBoundsException e) {
        }
        try {
            list1.remove(99);
            fail("Remove: check out of bounds to heigh");
        } catch (IndexOutOfBoundsException e) {
        }
    ...
    public void testAddAtIndex() {
        ...
        try {
            list3.add(-1, 99);
            fail("AddAtIndex: Check out of bounds to low");
        } catch (IndexOutOfBoundsException e) {
        }
        try {
            list3.add(99, 1);
            fail("AddAtIndex: Check out of bounds to high");
        } catch (IndexOutOfBoundsException e) {
        }
    }
    ...
    public void testSet() {
        ...
        try {
            listSet.set(-1, 1);
            fail("Check out of bounds to low");
        } catch (IndexOutOfBoundsException e) {

        }
        try {
            listSet.set(99, 1);
            fail("Check out of bounds to high");
        } catch (IndexOutOfBoundsException e) {
